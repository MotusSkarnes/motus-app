...
export const DEFAULT_INSPIRATION_RECIPES: DefaultInspirationRecipe[] = [
  ...
  },
  {
    ...
    description: "Raskt mellommåltid med protein, karbohydrater og sunt fett.",
  ...
  },
  {
    ...
    description: "Kjapt mellommåltid før eller etter trening.",
