...
export function buildTrainerLayoutProps(input: {
  ...
  restoreMembersFromRosterBackup: TrainerLayoutProps["restoreMembersFromRosterBackup"];
...
export function buildMemberLayoutProps(input: {
  ...
  markChatConversationRead: MemberLayoutProps["markChatConversationRead"];
  ...
  deleteWorkoutLog: MemberLayoutProps["deleteWorkoutLog"];
  ...
  markMemberMessagesAsRead: MemberLayoutProps["markMemberMessagesAsRead"];
  ...
  memberNoPlanCoverImageUrl?: MemberLayoutProps["memberNoPlanCoverImageUrl"];
